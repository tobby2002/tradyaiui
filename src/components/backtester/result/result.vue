<template>
  <div class="q-my-md">
    <div class="text-h6 q-mb-md">Backtest result</div>
    <div>
      ...
      <q-card flat bordered class="q-my-md">
        ...
        <q-card-actions align="around">
          <excel-json
            ...
            type="csv"
          >
            <q-btn outline  flat icon="file_download" label="backtest CSV" color="amber"></q-btn>
          </excel-json>
          <excel-json
            :data="genExportable()"
            ...
            type="xls"
          >
            <q-btn outline  flat icon="file_download" label="backtest XLS" color="amber"></q-btn>
          </excel-json>
          <excel-json
            ...
            type="xls"
          >
            <q-btn outline  flat icon="file_download" label="roundtrips XLS" color="teal"></q-btn>
          </excel-json>
          <excel-json
            v-if="result.roundtrips && result.roundtrips.length"
            :data="result.roundtrips"
            ...
            type="csv"
          >
            <q-btn outline  flat icon="file_download" label="roundtrips csv" color="teal"></q-btn>
          </excel-json>
        </q-card-actions>
      </q-card>
    </div>
