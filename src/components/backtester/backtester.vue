<template>
  <div>
    <div class="text-h4 q-mb-md">Backtest</div>
    ...
    <div class="row justify-center q-mt-md" v-if="backtestable">
      <q-btn outline  color="teal" :loading="backtestState === 'fetching'" :disabled="backtestState === 'fetching'" @click.prevent="run">Start Backtest</q-btn>
    </div>
    <div class="row justify-center q-mt-md" v-if="backtestable">
...
<!--      <q-btn outline  color="red" class="q-mr-xs" :disabled="backtestState === 'fetching'" @click.prevent="startLiveGekko(false)" icon="flash on" label="Start Tradebot" />-->
<!--      <q-btn outline  color="amber-8" class="q-ml-xs" :disabled="backtestState === 'fetching'" @click.prevent="startLiveGekko(true)" icon="remove red eye" label="Start Paper Trader" />-->
<!--    </div>-->
