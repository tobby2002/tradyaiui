    ...
    <q-tab-panels v-model="selectedTab" animated>
      <q-tab-panel name="available-data">
        <div v-if="datasetScanstate === 'idle'">
          <q-btn outline  color="primary" label="Scan available data" @click.prevent="scan"/>
        </div>
      ...
      <q-tab-panel name="import-data">
        <div class="row justify-center">
          <div class="text-center">
            ...
            <q-btn outline  color="primary" label="Go to the importer!" @click.prevent="$router.push('data/importer')"/>
          </div>
        </div>
      </q-tab-panel>
    </q-tab-panels>
