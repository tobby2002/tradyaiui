<template>
  <div>
    <div class="text-h6 q-mb-md">Dataset {{selectedText}}</div>
    <div class="text-center" v-if="datasetScanstate === 'idle'">
      <q-btn outline  color="primary" @click.prevent="scan">Scan available data</q-btn>
    </div>
    ...
    <div v-if="datasetScanstate === 'scanned'">
      ...
      <div class="text-center q-pa-sm" v-if="datasets.length">
        ...
        <q-btn outline  class="q-ma-xs" color="amber" icon="refresh" @click.prevent="scan">reload datasets</q-btn>
      </div>
