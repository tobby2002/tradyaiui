<template>
  <q-layout view="lHh Lpr fff">
    <q-header>
      <q-toolbar class="bg-teal">
        ...
        <q-tabs shrink stretch>
          ...
          <q-route-tab icon="cast_connected" label="Trade" to="/live-gekkos" exact>
      ...
      <q-toolbar v-if="currentWatchers.length > 0" class="bg-teal-5">
    ...
    <q-footer reveal class="hidden">
      <q-toolbar class="bg-blue-grey-7">
        <div>
          <div class="text-h6">Trady AI v {{version.ui}}</div>
        ...
        <div>
          ...
          <div class="text-subtitle" v-if="version.gekko">Using TradyAI v {{version.gekko}}</div>
        </div>
        <q-space></q-space>
        <q-toolbar-title>
